...
//
//     let usersWithCities = [];
//     for (let userId in usersWithId) {
//         for (let citiesId in citiesWithId) {
//             if (usersWithId[userId]['id'] === citiesWithId[citiesId]['user_id']) {
//                 usersWithId[userId].address = citiesWithId[citiesId];
//                 usersWithCities.push(usersWithId[userId]);
//             }
//
//         }
//     }
